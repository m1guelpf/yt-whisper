...
Alternatively, install into an isolated virtual environment using [pipx](https://github.com/pypa/pipx#install-pipx):

   pipx install git+https://github.com/m1guelpf/yt-whisper.git  
